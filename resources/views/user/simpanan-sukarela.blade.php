    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <section class="mb-4 hidden-content-right">
                <div class="card shadow" style="border: 1px solid #435ebe;">
                    <div class="card-body">
                        <span class="fw-bold d-flex align-items-center hidden-content-right">
            ...
            <section class="mb-4 hidden-content-right">
                <div class="card shadow" style="border: 1px solid #435ebe;">
                    <div class="card-body text-center">
                        <h5 class="pb-2 mb-3 border-bottom hidden-content-right">
                            <i class="bi bi-wallet2 text-success"></i> Saldo Simpanan Sukarela
                        </h5>
                        <h2 class="font-extrabold mt-3 text-primary hidden-content-right">
                    ...
                    <div class="card-body hidden-content-right">
                        ...
                        <div style="max-height: 400px; overflow:auto; font-size:.9rem;">
                            <table class="table table-hover hidden-content-right">
                                ...
                                <tbody id="data-sukarela" class="hidden-content-right">
            ...
            <div class="alert p-4 shadow hidden-content-right" style="background-color: #ff5733; color: #fff; border-radius: 10px;">
                <div class="d-flex align-items-start hidden-content-right">
                    <i class="bi bi-exclamation-triangle-fill fs-1 me-3 hidden-content-right" style="color: #fff700; margin-top:-15px; padding-right:30px;"></i>
                    <div>
                        <h4 class="text-white hidden-content-right">Penting: <span class="badge" style="background-color: #fff700; color: #ff5733;">Perhatian</span></h4>
                        <p style="text-align: justify;" class="hidden-content-right">
                            ...
                            <br>
                            <i class="bi bi-file-earmark-text hidden-content-right"></i> <strong>Syarat:</strong> Bawa <strong>bukti tangkapan layar</strong> dari halaman ini pada bagian <strong>Saldo Simpanan Sukarela</strong> sebagai bukti kepemilikan Simpanan Sukarela.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <section class="mb-4 hidden-content-right">
                <div class="card shadow" style="border: 1px solid #435ebe;">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="pb-2 border-bottom hidden-content-right" style="margin-top: 10px;"><i class="bi bi-file-earmark-text"></i> Formulir Penyetoran / Penarikan</h5>
                        <form action="{{ route('simpanan.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                ...
                <div class="card-body bg-info text-dark" style="border: 1px solid #17a2b8; border-radius: 10px;">
                    <div class="d-flex align-items-start hidden-content-right">
                        ...
                        <div>
                            ...
                            <p style="color: rgb(80, 83, 85);" class="hidden-content-right">
                ...
                <div class="card-body bg-danger text-white" style="border: 1px solid #ff6b6b; border-radius: 10px;">
                    <div class="d-flex align-items-start hidden-content-right">
                        ...
                        <div>
                            ...
                            <p style="color: rgb(255, 230, 230);" class="hidden-content-right">
            ...
            <section class="mb-4 hidden-content-right">
                <div class="card shadow" style="border: 1px solid #435ebe;">
                    ...
                    <div class="card-body hidden-content-right">
                        @if ($statusSukarela && $statusSukarela->status === 'Dalam Proses')
                        <!-- Jika ada transaksi dalam proses -->
                        <div class="hidden-content-right alert alert-warning d-flex align-items-center" role="alert">
                            <i class="bi bi-hourglass-split me-3" style="font-size: 2rem;"></i>
                            <div class="hidden-content-right">
                                <h5 class="alert-heading hidden-content-right">Transaksi Sedang Diproses</h5>
                                <p class="hidden-content-right">Anda memiliki transaksi yang masih dalam proses. Silakan tunggu hingga transaksi selesai sebelum mengajukan yang baru.</p>
                            </div>
                        </div>
                        @else
                        <!-- Jika tidak ada transaksi dalam proses, tampilkan form -->
