    ...
    <div id="app">
        ...
        <div id="main">
                ...
                <div class="card shadow-sm hidden-content-right">
                    ...
                    <div class="card-body hidden-content-right" style="margin-top: 30px; text-align: left;">
                        <form action="{{ route('simpanan.bayar') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <button type="submit" class="btn btn-primary w-100 hidden-content-right"><i class="bi bi-send hidden-content-right"></i> Bayar Sekarang</button>
                        </form>
                    </div>
                </div>
            </div>
            ...
            <div class="page-heading d-flex align-items-center pb-3 border-bottom hidden-content-right">
                <i class="bi bi-house-door me-2 fs-3 text-primary hidden-content-right" style="margin-top: -30px; padding-right:30px;"></i>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-8 d-flex hidden-content-right" style="height: auto;">
                    <div class="card shadow mb-4 flex-grow-1 hidden-content-right">
                        <div class="card-header" style="background-color: #435ebe; color: #fff;">
                            <h5 class="mb-0 text-white hidden-content-right">
                                <i class="bi bi-person-circle"></i> Profil Pengguna
                            </h5>
                        </div>
                        <div class="card-body d-flex flex-column flex-lg-row align-items-center align-items-lg-start justify-content-start p-4" style="border: 1px solid rgb(7, 81, 160); border-bottom-right-radius:10px;border-bottom-left-radius:10px;">
                            <div class="text-center text-lg-start me-lg-4">
                                <div class="poto-profil hidden-content-right">
                                    <img src="{{ asset('picture/account/' . Auth::user()->gambar) }}" alt="Foto Profil" class="rounded-circle img-fluid" style="width: 180px; height: 180px; object-fit: cover;">
                                </div>
                            </div>
                            <div class="ms-lg-4 text-center text-lg-start hidden-content-right">
                                <h3 class="fw-bold mb-3 hidden-content-right" style="font-size: 28px;">{{ Auth::user()->fullname }}</h3>
                                <p class="mb-3 hidden-content-right" style="font-size: 18px;">
                                ...
                                <p class="mb-0 hidden-content-right" style="font-size: 18px;">
                ...
                <!-- Bagian Statistik (30%) -->
                <div class="col-12 col-lg-4 d-flex flex-column hidden-content-right">
                    <div class="d-flex flex-column gap-3 h-100">
                        <!-- Card: Total Simpanan -->
                        <div class="card flex-grow-1 shadow hidden-content-right" style="border: 1px solid #435ebe;">
                            <div class="card-body">
                                <div class="stats-icon blue hidden-content-right" style="border: 1px solid #435ebe;">
                                    <i class="bi bi-wallet2" style="margin-right:10px; margin-bottom: 22px;"></i>
                                </div>
                                <h6 class="text-muted font-semibold hidden-content-right">Total Simpanan</h6>
                                <h6 class="font-extrabold mb-0 hidden-content-right">Rp {{ number_format($totalSimpananSeluruh ?? 0, 0, ',', '.') }}</h6>
                            </div>
                        </div>
                        ...
                        <div class="card flex-grow-1 shadow  hidden-content-right" style="border: 1px solid #435ebe;">
                            <div class="card-body">
                                <div class="stats-icon green hidden-content-right" style="border: 1px solid #435ebe;">
                                    <i class="bi bi-cash" style="margin-right:10px; margin-bottom: 22px;"></i>
                                </div>
                                <h6 class="text-muted font-semibold hidden-content-right">Total Pinjaman</h6>
                                <h6 class="font-extrabold mb-0 hidden-content-right">Rp {{ number_format($totalPinjamanSeluruh, 0, ',', '.') }}</h6>
                            </div>
                        </div>
                        ...
                        <div class="card flex-grow-1 shadow hidden-content-right" style="border: 1px solid #435ebe;">
                            <div class="card-body">
                                <div class="stats-icon orange hidden-content-right" style="border: 1px solid #435ebe;">
                                    <i class="bi bi-bell" style="margin-right:10px; margin-bottom: 22px;"></i>
                                </div>
                                <h6 class="text-muted font-semibold hidden-content-right">Notifikasi</h6>
                                <h6 class="font-extrabold mb-0 hidden-content-right">{{ $jumlahNotifikasiBaru }}</h6>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="page-content hidden-content-right">
                ...
                <div class="row hidden-content-right">
                    <!-- Diagram -->
                    <div class="col-12 col-md-8 hidden-content-right">
                    ...
                    <!-- Aksi Cepat -->
                    <div class="col-12 col-md-4 hidden-content-right">
                        <div class="card shadow-sm border-0">
                            <div class="card-body text-center shadow hidden-content-right" style="border: 1px solid #435ebe; border-radius:10px;">
                                <h5 class="fw-bold hidden-content-right">
                                    <i class="bi bi-lightning-charge text-warning hidden-content-right"></i> Aksi Cepat
                                </h5>
                                <a href="{{route('simpanansukarela')}}">
                                    <button class="hidden-content-right btn btn-primary w-100 mb-2" id="btnStartSaving">
                                        <i class="bi bi-plus-circle"></i> Mulai Simpanan
                                    </button>
                                </a>
                                <a href="{{route('pinjaman')}}">
                                    <button class="hidden-content-right btn btn-success w-100 mb-2" id="btnStartLoan">
                                        <i class="bi bi-arrow-up-circle"></i> Mulai Pinjaman
                                    </button>
                                </a>
                                <a href="{{route('bantuan')}}">
                                    <button class="hidden-content-right btn btn-info w-100 mb-2" id="btnContactSupport">
                ...
                <div class="card shadow hidden-content-right" style="border: 1px solid #435ebe;">
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0 text-white hidden-content-right">
                            <i class="bi bi-list-check"></i> Daftar Transaksi Terbaru
                        </h5>
                    </div>
                    <div class="card-body hidden-content-right">
                        <!-- Input Pencarian -->
                        <div style="margin-bottom: 20px; position: relative;">
                            <div class="input-group hidden-content-right">
                                <input
                                    ...
                                    id="search-transaksi"
                                    class="form-control"
                                    placeholder="Cari berdasarkan Deskripsi, Tanggal, atau Status..."
                        ...
                        <div style="max-height: 450px; overflow:auto; font-size:.9rem;">
                            <table class="table table-hover hidden-content-right" style="text-align: left;">
                                ...
                                <tbody id="data-transaksi" class="hidden-content-right">
                                    ...
                                    <tr>
                                        ...
                                        <td class="hidden-content-right">{{ $transaksi['deskripsi'] ?? '-' }}</td>
                                    ...
                                    @empty
                                    <tr>
                                        <td class="hidden-content-right" colspan="5" class="text-center">
            ...
            <div class="page-heading d-flex align-items-center pb-3 border-bottom hidden-content-right">
                ...
                <h2 class="mb-0 fw-bold">Beranda</h2>
            </div>
            <div class="row hidden-content-right">
                <!-- Bagian Profil Pengguna (70%) -->
                <div class="col-12 col-lg-8 d-flex hidden-content-right" style="height: auto;">
                    <div class="card shadow mb-4 flex-grow-1 hidden-content-right">
                        ...
                        <div class="card-body d-flex flex-column flex-lg-row align-items-center align-items-lg-start justify-content-start p-4" style="border: 1px solid rgb(7, 81, 160); border-bottom-right-radius:10px;border-bottom-left-radius:10px;">
                            <div class="text-center hidden-content-right text-lg-start me-lg-4">
                                <div class="poto-profil hidden-content-right">
                                    <img src="{{ asset('picture/account/' . Auth::user()->gambar) }}" alt="Foto Profil" class="rounded-circle img-fluid" style="width: 180px; height: 180px; object-fit: cover;">
                                </div>
                            </div>
                            <div class="ms-lg-4 text-center hidden-content-right text-lg-start">
                ...
                <!-- Bagian Statistik (30%) -->
                <div class="col-12 col-lg-4 d-flex flex-column hidden-content-right">
                    <div class="d-flex flex-column hidden-content-right gap-3 h-100">
                        <!-- Card: Total Simpanan -->
                        <div class="card flex-grow-1 shadow hidden-content-right" style="border: 1px solid #435ebe;">
                            <div class="card-body hidden-content-right">
                                ...
                                <h6 class="font-extrabold mb-0">Rp {{ number_format($totalSimpananSeluruh ?? 0, 0, ',', '.') }}</h6>
                            </div>
                        </div>
                        ...
                        <div class="card flex-grow-1 shadow hidden-content-right" style="border: 1px solid #435ebe;">
                            <div class="card-body hidden-content-right">
                                ...
                                <h6 class="font-extrabold mb-0">Rp {{ number_format($totalPinjamanSeluruh, 0, ',', '.') }}</h6>
                            </div>
                        </div>
            ...
            <div class="page-content hidden-content-right">
                ...
                <div class="row hidden-content-right">
                    ...
                    <!-- Aksi Cepat -->
                    <div class="col-12 col-md-4 hidden-content-right">
                        <div class="card shadow-sm border-0 hidden-content-right">
                            ...
                            <table class="table table-hover" style="text-align: left;">
                                ...
                                <tbody id="data-transaksi" class="hidden-content-right">
                                    ...
                                    <tr>
                                        ...
                                        <td class="hidden-content-right">{{ \Carbon\Carbon::parse($transaksi['tanggal'])->format('Y-m-d') }}</td>
                                        <td class="hidden-content-right">
                                            <span class="badge bg-{{ $transaksi['jumlah'] >= 0 ? 'success' : 'primary' }}">
                                                Rp {{ number_format($transaksi['jumlah'], 0, ',', '.') }}
                                            </span>
                                        </td>
                                        <td class="hidden-content-right">
