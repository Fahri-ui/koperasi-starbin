                    ...
                    <div class="d-flex flex-column gap-3 h-100">
                        ...
                        <div class="card flex-grow-1 shadow hidden-content-right" style="border: 1px solid #435ebe;">
                            <div class="card-body">
                                ...
                                <h6 class="font-extrabold mb-0 hidden-content-right">Rp {{ number_format($totalSimpanan ?? 0, 0, ',', '.') }}</h6>
                            </div>
                        </div>
                        ...
                        <div class="card flex-grow-1 shadow  hidden-content-right" style="border: 1px solid #435ebe;">
                            <div class="card-body">
                                ...
                                <h6 class="font-extrabold mb-0 hidden-content-right">Rp {{ number_format($totalPinjaman, 0, ',', '.') }}</h6>
                            </div>
                        </div>
