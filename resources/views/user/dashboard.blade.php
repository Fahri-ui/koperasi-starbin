        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            var financialChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        data: [{{ $totalSukarela }}, {{ $totalPinjaman }}], // Data dari Controller
                        backgroundColor: ['#28a745', '#dc3545'], // Warna hijau untuk simpanan, merah untuk pinjaman
                ...
                options: {
                    ...
                    plugins: {
                        legend: {
                            display: false // Menghilangkan legenda "Jumlah (Rp)"
                        }
                    }
                }
            });
