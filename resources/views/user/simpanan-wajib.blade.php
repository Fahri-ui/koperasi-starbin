            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="alert alert-warning" role="alert">
                        Anda belum melakukan pembayaran untuk bulan ini. <a href="#" class="alert-link">Bayar Sekarang</a>.
                    </div>
                    <div class="alert alert-success d-none" role="alert">
                        Anda sudah membayar simpanan pokok bulan ini. Terima kasih!
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="alert alert-info" role="alert">
                        Anda akan menerima pengingat otomatis setiap awal bulan jika belum melakukan pembayaran.
                    </div>
                </div>
            </div>
        </section>
