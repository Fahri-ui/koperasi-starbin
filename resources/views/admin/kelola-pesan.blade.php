        ...
        <div id="main">
            ...
            <div class="container">
                <div class="page-header mb-4 hidden-content-right">
                    <h3 class="fw-bold">
                        <i class="bi bi-send"></i> Kelola Pesan
                    </h3>
                </div>
                        ...
                        <div class="card-body hidden-content-right">
                            ...
                            <div style="max-height: 700px; overflow:auto; font-size:.8rem; text-align:left;">
                                <table class="table table-hover hidden-content-right">
                                    ...
                                    <tbody id="data-message" class="hidden-content-right">
                                        ...
                                        <tr>
                                            ...
                                            <td class="hidden-content-right">{{ $item->message }}</td>
                                            <td class="hidden-content-right">{{ \Carbon\Carbon::parse($item->created_at)->format('d F Y') }}</td>
                                            <td class="hidden-content-right">
