...
<head>
    ...
    <title>Log Aktivitas Koperasi STARBIN</title>
    ...
    <link rel="stylesheet" href="{{ asset('admin-page/assets/css/log-aktivitas.css') }}">
...
<body>
        ...
        <ul class="menu">
            ...
            <li
                ...
                <ul class="submenu ">
                    ...
                    <li class="submenu-item ">
                        <a href="simpanan-pokok.html">Simapanan Pokok</a>
                    </li>
                    <li class="submenu-item ">
            ...
            <ul class="submenu ">
                <li class="submenu-item ">
                    <a href="simpanan-wajib.html">Profil Admin</a>
                </li>
                <li class="submenu-item ">
                    <a href="simpanan-pokok.html">Backup</a>
                </li>
            </ul>
        </li>
        ...
        <div id="main">
            ...
            <div class="container mt-4">
                ...
                <div class="card mb-4">
                  <div class="card-body">
                    <h5>Ringkasan</h5>
                    <p>Total Aktivitas: <span id="total-activity">0</span></p>
                    <p>Aktivitas Terakhir: <span id="last-activity">-</span></p>
                  </div>
                </div>
                ...
                <div class="card mb-4">
                  <div class="card-body">
                    ...
                    <form class="row" id="filter-form">
                      ...
                      <div class="col-md-4">
                        <label for="filter-user" class="form-label">Nama Pengguna</label>
                        <input type="text" id="filter-user" class="form-control" placeholder="Masukkan nama pengguna">
                      </div>
                      <div class="col-md-4">
                        <label for="filter-activity" class="form-label">Jenis Aktivitas</label>
                      ...
                      <div class="col-md-12 mt-3">
                        <button type="button" class="btn btn-primary" id="filter-btn">Cari</button>
                      </div>
                    </form>
                  </div>
                </div>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <table class="table table-striped" id="log-table">
                      ...
                      <tbody>
                        <!-- Data log akan ditampilkan di sini melalui JS -->
                      </tbody>
                    </table>
                    <button class="btn btn-secondary mt-3" id="export-pdf">Export ke PDF</button>
                    <button class="btn btn-secondary mt-3" id="export-excel">Export ke Excel</button>
                  </div>
                </div>
              </div>
    ...
    <script src="{{ asset('admin-page/assets/js/log-aktivitas.js') }}"></script>
