...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('admin-page/assets/css/profil.css') }}">
...
<body>
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <li
                class="sidebar-item  ">
                <a href="bantuan.html" class='sidebar-link'>
                ...
                <div class="container">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <p>Tanggal Bergabung: 1 Januari 2020</p>
                            <p>Total Simpanan: Rp 50,000,000</p>
                            <p>Total Pinjaman: Rp 20,000,000</p>
                        </div>
                    </div>
