    ...
    <div class="data-simpanan-container">
      ...
      <div style="height: 470px; overflow: auto;">
        ...
        <table class="table table-striped mt-3">
          <thead>
            <tr>
              ...
              <th>Tanggal Terakhir Simpanan</th>
              <th>Status</th>
            </tr>
          </thead>
        ...
        <div class="simpanan-statistik mt-3">
          <h4>Total Simpanan: <span id="total-simpanan-statistik">Rp 0</span></h4>
        </div>
      </div>
...
<script src="{{ asset('admin-page/assets/js/simpanan-wajib.js') }}"></script>
