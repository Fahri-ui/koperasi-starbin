...
<head>
    ...
    <title>Data Pengajuan Pinjaman Koperasi STARBIN</title>
    ...
    <div id="app">
        <div id="sidebar" class="active">
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-footer d-flex align-items-center justify-content-between py-3 border-bottomhidden-content">
                    <!-- Logo & Nama Koperasi -->
                    ...
                    <div class="card shadow hidden-content-right" style="border: 1px solid #435ebe;">
                        <div class="card-body">
                            ...
                            <p class="hidden-content-right">
                                Halaman ini digunakan untuk mengelola pengajuan Pinjaman. Di dalamnya terdapat daftar pengajuan, status persetujuan. Admin dapat menyetujui, atau menolak pengajuan sesuai kebijakan yang berlaku.
                                <br><br>
                    ...
                    <div class="card shadow" style="border: 1px solid #435ebe;">
                        <div class="card-body hidden-content-right">
                            ...
                            <div class="row hidden-content-right">
                                <div class="col-md-3 hidden-content-right">
                                ...
                                <table class="table table-hover hidden-content-right">
                                    ...
                                    <tbody class="hidden-content-right">
                                        ...
                                        <tr>
                                            ...
                                            <td class="hidden-content-right">{{ $item->user->fullname ?? '-' }}</td>
                                            <td class="hidden-content-right">{{ $item->tanggal_pengajuan ?? '-' }}</td>
                                            <td class="hidden-content-right">{{ $item->tanggal_jatuh_tempo ?? '-' }}</td>
                                        ...
                                        @empty
                                        <tr>
                                            <td class="hidden-content-right text-center" colspan="8" class="text-center">
