...
<body>
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="container">
                <h2 class="text-center fw-bold my-4 hidden-content-right">📢 Halaman Notifikasi Admin</h2>
                ...
                <div class="d-flex flex-column align-items-center hidden-content-right">
                    ...
                    @foreach ($notifikasi->sortByDesc('created_at') as $item)
                    <div class="card shadow mb-4 rounded border-1 {{ $item->is_read ? '' : 'border-primary' }} hidden-content-right">
                        <div class="d-flex">
                            <!-- Profil Pengirim -->
                            <div class="d-flex flex-column align-items-center bg-primary text-white p-3"
                                style="border-top-left-radius:10px; border-bottom-left-radius:10px;">
                                <img src="{{ asset('picture/account/' . ($item->gambar_pengirim ?? 'default.png')) }}"
                                    alt="Profil Pengirim"
                                    class="rounded-circle border border-white shadow-sm"
                                    style="width: 120px; height: 120px; object-fit: cover;">
                            </div>

                            <!-- Bagian Kanan: Header, Isi Pesan, Footer -->
                            <div class="flex-grow-1">
                                <!-- Header -->
                                <div class="bg-primary text-white p-2" style="border-top-right-radius: 10px;">
                                    <h3 class="fw-bold mb-0 text-white">
                                        {{ $item->is_from_user ? 'Pesan dari ' . $item->nama_pengirim : 'Pesan Umum' }}
                                    </h3>
                                </div>
                                ...
                                <!-- Footer: Tanggal dan Tombol Aksi -->
