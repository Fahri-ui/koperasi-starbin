...
<head>
    ...
    <title>Backup Koperasi STARBIN</title>
    ...
    <link rel="stylesheet" href="{{ asset('admin-page/') }}assets/css/backup.css">
...
<body>
    ...
    <div class="sidebar-menu" style="margin-left: -10px;">
        ...
        <div id="main">
            ...
            <div class="container mt-4">
                ...
                <div class="card mb-4">
                  <div class="card-body">
                    <h5>Backup Terakhir</h5>
                    <p>Tanggal: 24 Januari 2025, pukul 09:00 WIB</p>
                    <p>Ukuran File: 25 MB</p>
                    <p>Lokasi: Lokal Server</p>
                    <button class="btn btn-primary btn-sm">Buat Backup Baru</button>
                  </div>
                </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <h5>Restore Data</h5>
                    <p>Unggah file backup untuk mengembalikan data.</p>
    ...
    <script src="{{ asset('admin-page/assets/js/backup.js') }}"></script>
