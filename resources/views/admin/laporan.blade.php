...
<body>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="row text-center">
                            <div class="col-md-3">
                                <h6>Total Anggota</h6>
                                <p><strong>{{ $totalAnggota }}</strong></p>
                            </div>
                            <div class="col-md-3">
                                <h6>Total Simpanan</h6>
                                <p><strong>Rp {{ number_format($totalSimpanan, 0, ',', '.') }}</strong></p>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <p><strong>Rp {{ number_format($totalAngsuran, 0, ',', '.') }}</strong></p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        // Mengambil elemen input pencarian dan tabel body
        ...
        searchInput.addEventListener('keyup', function() {
            ...
            Array.from(rows).forEach(row => {
                ...
                // Memeriksa apakah salah satu kolom cocok dengan query pencarian
