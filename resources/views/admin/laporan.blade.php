...
<head>
    ...
    <title>Laporan Koperasi STARBIN</title>
    ...
    <link rel="stylesheet" href="{{ asset('admin-page/assets/css/laporan.css') }}">
...
<body>
            ...
            <div class="container mt-4">
                ...
                <div class="card mb-4">
                  <div class="card-body">
                    ...
                    <div class="row text-center">
                      <div class="col-md-3">
                        <h6>Total Anggota</h6>
                        <p><strong id="total-anggota">0</strong></p>
                      </div>
                      <div class="col-md-3">
                        <h6>Total Simpanan</h6>
                        <p><strong id="total-simpanan">Rp 0</strong></p>
                      </div>
                      <div class="col-md-3">
                        <h6>Total Pinjaman</h6>
                        <p><strong id="total-pinjaman">Rp 0</strong></p>
                      </div>
                      <div class="col-md-3">
                        <h6>Total Angsuran</h6>
                        <p><strong id="total-angsuran">Rp 0</strong></p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card mb-4">
                  <div class="card-body">
                    ...
                    <form class="row" id="filter-laporan">
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        <label for="filter-kategori" class="form-label">Kategori Laporan</label>
                      ...
                      <div class="col-md-12 mt-3">
                        <button type="button" class="btn btn-primary" id="filter-btn">Tampilkan Laporan</button>
                      </div>
                    </form>
                  </div>
                </div>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <table class="table table-striped" id="laporan-table">
                      ...
                      <tbody>
                        <!-- Data laporan akan di-render melalui JS -->
                      </tbody>
                    </table>
    ...
    <script src="{{ asset('admin-page/assets/js/laporan.js') }}"></script>
