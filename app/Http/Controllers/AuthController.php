...
class AuthController extends Controller
{
    ...
    { 
        ...
        $request->validate([
            ...
            'gambar' => 'required|image|file', // File gambar wajib diunggah
        ],[
            ...
            'gambar.required' => 'Gambar harus upload',
            'gambar.image' => 'Gambar yang diupload harus berupa image',
        ...
        $gambar_ekstensi = $gambar_file->extension(); // Mendapatkan ekstensi file
        $nama_gambar = date('ymdhis') . "." . $gambar_ekstensi; // Membuat nama file unik
